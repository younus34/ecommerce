 ...
 */
package com.spring.ecommerce_management.configuration;
...
//    }
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[] { "com.spring.ecommerce_management.domain" });
    ...
    public DataSource getDataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/spring_shopping");
