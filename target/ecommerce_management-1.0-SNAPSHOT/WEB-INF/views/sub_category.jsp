...
<html>
   ...
   <center>
        <div ng-controller="SubCategoryController as objCtrl">
            ...
            <form name="objForm" method="POST">
                <table>
                    <tr><td colspan="2">
                            ...
                            <div ng-if="objCtrl.flag == 'edit'">
                                <h3> Update SubCategory for ID: {{ objCtrl.obj.subCatId}} </h3> 
                            </div> </td>
                    </tr>
                    <tr>
                        <td>Category Name</td>
                    ...
                    <tr>
                        <td>SubCategory name </td> <td><input type="text" name="facultyCode" ng-model="objCtrl.obj.subCatName" required/> 
                            <span ng-show="objForm.subCatName.$error.required" class="msg-val">SubCategory Code is required.</span> </td>
                    </tr>
                    <tr>
                        <td>SubCategory description </td> <td><input type="text" name="facultyName" ng-model="objCtrl.obj.subCatDesc" required/> 
                            <span ng-show="objForm.subCatDesc.$error.required" class="msg-val">subCatDesc  is required.</span> </td>
                    </tr>
                    ...
                    <tr><td colspan="2">
                            <div ng-if="objCtrl.flag != 'edit'">
                                <input  type="submit" ng-click="objCtrl.addObject()" value="Add SubCategory"/> 
                                <input type="button" ng-click="objCtrl.reset()" value="Reset"/>
                            </div>
                            <div ng-if="objCtrl.flag == 'edit'">
                                <input  type="submit" ng-click="objCtrl.updateObjectDetail()" value="Update SubCategory"/> 	
            ...
            <table>
                ...
                <tr ng-repeat="row in objCtrl.objArray">
                    ...
                    <td>
                        <input type="button" ng-click="objCtrl.deleteObject(row.subCatId)" value="Delete"/>
                        <input type="button" ng-click="objCtrl.editObject(row.subCatId)" value="Edit"/>
                        <span ng-if="objCtrl.flag == 'updated' && row.subCatId == objCtrl.updatedId" class="msg-success">SubCategory successfully updated.</span> </td> 
                </tr>	
